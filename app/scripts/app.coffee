...
.config ['$routeProvider', 'FacebookConfigProvider', ($routeProvider, FacebookConfigProvider) ->
  $routeProvider
  .when '/',
  ...
  #FacebookConfigProvider.setAppId('399206153584665') #test
  FacebookConfigProvider.setAppId('399205503584730') #prod
  FacebookConfigProvider.setLocale('ko_KR')
  #FacebookConfigProvider.setLocale('en_US')
]

.run ['$rootScope', '$location', '$route', '$anchorScroll', ($rootScope, $location, $route, $anchorScroll) ->
